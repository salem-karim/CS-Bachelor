...
// Funktion, die die Zahl mit 3 multipliziert (nur Transformation)
...
int main() {
    ...
    // Beispiel 3: Multiply by 3 mit Logs
    WrapWithLogs result3 = runWithLogs(wrapWithLogs(4), multiplyByThree);

    // Ergebnis und Logs ausgeben
    std::cout << "Example 3: runWithLogs(wrapWithLogs(4), multiplyByThree)\n";
